...
Elm.Main.make = function (_elm) {
   ...
   var updateSprite = function (_p22) {    var _p23 = _p22;var newSprite = _U.eq(_p23.sprite,0) ? 1 : 0;return _U.update(_p23,{sprite: newSprite});};
   var Away = {ctor: "Away"};
   var Toward = {ctor: "Toward"};
   var Right = {ctor: "Right"};
   var Left = {ctor: "Left"};
   var setDirection = F2(function (_p24,model) {
      var _p25 = _p24;
      var _p27 = _p25.y;
      var _p26 = _p25.x;
      return _U.update(model,
      {orientation: _U.cmp(_p27,0) < 0 ? Toward : _U.cmp(_p27,0) > 0 ? Away : model.orientation
      ,dir: _U.cmp(_p26,0) > 0 ? Right : _U.cmp(_p26,0) < 0 ? Left : model.dir});
   });
