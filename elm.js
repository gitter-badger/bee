...
Elm.Sprite.make = function (_elm) {
   ...
   var beeFromSpriteSheet = imgFromSpriteSheet("bee4.png");
   var northBee1 = beeFromSpriteSheet({ctor: "_Tuple2",_0: 0,_1: 0});
   var northBee2 = beeFromSpriteSheet({ctor: "_Tuple2",_0: 64,_1: 0});
   var southBee1 = beeFromSpriteSheet({ctor: "_Tuple2",_0: 0,_1: 32});
   var southBee2 = beeFromSpriteSheet({ctor: "_Tuple2",_0: 64,_1: 32});
   var eastBee1 = beeFromSpriteSheet({ctor: "_Tuple2",_0: 32,_1: 32});
   var eastBee2 = beeFromSpriteSheet({ctor: "_Tuple2",_0: 96,_1: 32});
   var westBee1 = beeFromSpriteSheet({ctor: "_Tuple2",_0: 32,_1: 0});
   var westBee2 = beeFromSpriteSheet({ctor: "_Tuple2",_0: 96,_1: 0});
   var tileFromSpriteSheet = imgFromSpriteSheet("dirtpath.png");
   var grass1 = tileFromSpriteSheet({ctor: "_Tuple2",_0: 0,_1: 0});
   var rightDirt = tileFromSpriteSheet({ctor: "_Tuple2",_0: 0,_1: 32});
   var bottomLeftDirt = tileFromSpriteSheet({ctor: "_Tuple2",_0: 0,_1: 64});
   var grass2 = tileFromSpriteSheet({ctor: "_Tuple2",_0: 32,_1: 0});
   var dirt = tileFromSpriteSheet({ctor: "_Tuple2",_0: 32,_1: 32});
   var bottomRightDirt = tileFromSpriteSheet({ctor: "_Tuple2",_0: 32,_1: 64});
   var bottomDirt = tileFromSpriteSheet({ctor: "_Tuple2",_0: 64,_1: 0});
   var leftDirt = tileFromSpriteSheet({ctor: "_Tuple2",_0: 64,_1: 32});
   var topLeftDirt = tileFromSpriteSheet({ctor: "_Tuple2",_0: 64,_1: 64});
   var topDirt = tileFromSpriteSheet({ctor: "_Tuple2",_0: 96,_1: 0});
   var topRightDirt = tileFromSpriteSheet({ctor: "_Tuple2",_0: 96,_1: 32});
   return _elm.Sprite.values = {_op: _op
                               ...
                               ,grass1: grass1
                               ,rightDirt: rightDirt
                               ,bottomLeftDirt: bottomLeftDirt
                               ,grass2: grass2
                               ,dirt: dirt
                               ,bottomRightDirt: bottomRightDirt
                               ,bottomDirt: bottomDirt
                               ,leftDirt: leftDirt
                               ,topLeftDirt: topLeftDirt
                               ,topDirt: topDirt
                               ,topRightDirt: topRightDirt};
};
Elm.Map = Elm.Map || {};
...
Elm.Main.make = function (_elm) {
   ...
   var viewBee = function (_p0) {
      ...
      var beeImage = function () {
         var _p2 = {ctor: "_Tuple2",_0: _p1.dir,_1: _p1.sprite};
         _v1_8: do {
            switch (_p2._1)
            {case 0: switch (_p2._0)
                 {case "north": return $Sprite.northBee1;
                    case "south": return $Sprite.southBee1;
                    case "east": return $Sprite.eastBee1;
                    case "west": return $Sprite.westBee1;
                    default: break _v1_8;}
               case 1: switch (_p2._0)
                 {case "north": return $Sprite.northBee2;
                    case "south": return $Sprite.southBee2;
                    case "east": return $Sprite.eastBee2;
                    case "west": return $Sprite.westBee2;
                    default: break _v1_8;}
               default: break _v1_8;}
         } while (false);
         return $Sprite.northBee1;
      }();
      return A2($Html.div,
