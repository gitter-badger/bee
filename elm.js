...
Elm.Sprite.make = function (_elm) {
   ...
   var beeFromSpriteSheet = imgFromSpriteSheet("newbee.png");
...
Elm.Main.make = function (_elm) {
   ...
   var setDirection = F2(function (_p18,model) {
      ...
      {orientation: _U.cmp(_p21,0) < 0 ? "toward" : _U.cmp(_p21,0) > 0 ? "away" : model.orientation
      ,dir: _U.cmp(_p20,0) > 0 ? "right" : _U.cmp(_p20,0) < 0 ? "left" : model.dir});
   });
